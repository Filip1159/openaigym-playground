...
class NoisyFactorizedLinear(nn.Linear):
    """
    Warstwa NoisyNet z rozlozonym szumem gaussowskim.
    """
    def __init__(self, in_features, out_features,
...
def distr_projection(next_distr, rewards, dones, gamma):
    """
	 Wykonuje rzutowanie dystrybucji zwane algorytmem katgorycznym
	 zaprezentowane w artykule "A Distributional Perspective on RL"
    """
